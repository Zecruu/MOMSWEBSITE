...
const translations = {
  en: {
    ...
    decompressionDesc: "We deliver IDD Therapy® (Intervertebral Differential Dynamics) on the Accu-SPINA® system — not generic traction. This computer-controlled protocol targets a single disc, creates negative intradiscal pressure, and uses a patented oscillating waveform so the disc can rehydrate while surrounding muscles relax. It is used for herniated discs, sciatica, and neck or back pain.",
    ...
    lumbarCond3: "Lumbar spinal stenosis",
    lumbarCond4: "Facet syndrome and pinched nerves",
    ...
    cervicalCond5: "Whiplash and post-trauma neck pain",
  ...
  es: {
    ...
    decompressionDesc: "Aplicamos Terapia IDD® (Intervertebral Differential Dynamics) en el sistema Accu-SPINA® — no tracción genérica. Este protocolo controlado por computadora apunta a un solo disco, crea presión intradiscal negativa y usa una onda oscilante patentada para que el disco se rehidrate mientras los músculos se relajan. Se usa para hernias, ciática y dolor de cuello o espalda.",
    ...
    lumbarCond3: "Estenosis espinal lumbar",
    lumbarCond4: "Síndrome facetario y nervios pinchados",
    ...
    cervicalCond5: "Latigazo cervical y dolor post-traumático",
